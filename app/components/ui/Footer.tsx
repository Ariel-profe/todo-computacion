...
const Footer = () => {
  return (
    <Section crosses className="!px-0 !py-10" id="footer">
       <footer className="p-4 bg-n-8 sm:p-6">
        <div className="mx-auto max-w-screen-xl">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <Link href="/" className="flex items-center">
                        <img src={whiteLogo.src} className="mr-3 w-[15rem]" alt="tc-Logo" />
                    </Link>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h4 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Productos</h4>
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                                <Link href="/productos" className="hover:underline">Notebooks</Link>
                            </li>
                            <li className="mb-4">
                                <Link href="/nosotros" className="hover:underline">Accesorios</Link>
                            </li>
                            <li>
                    ...
                    <div>
                        <h4 className="mb-6 text-sm font-semibold uppercase">Empresa</h4>
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                                <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Nosotros</a>
                            </li>
                            <li>
                                <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Ubicación</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="mb-6 text-sm font-semibold uppercase">Legal</h4>
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <span className="text-sm">Desarrollado por {' '}
                    <a href="https://www.amn.com.ar" className="md:hover:text-n-3 transition">AMN Consultora Informática</a>
                </span>
